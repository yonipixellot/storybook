    ...
    <div class="game-result-card__content">
      ...
      <div class="game-result-card__row">
        <div class="game-result-card__team">
          <div class="game-result-card__logo" :style="{ backgroundColor: homeTeam.logoColor || '#fff' }">
      ...
      <div class="game-result-card__row">
        <div class="game-result-card__team">
          <div class="game-result-card__logo" :style="{ backgroundColor: awayTeam.logoColor || '#fff' }">
