  ...
  render: () => ({
    ...
    template: `
      <div style="${box}">
        ...
        <hr style="${hr}" />
        <GameResultCard
          :homeTeam="{ name: 'Maccabi Kiryat Gat', score: 89, logoInitial: 'M', logoColor: '#fff' }"
          :awayTeam="{ name: 'Ironi Nahariya', score: 77, logoInitial: 'I', logoColor: '#fff' }"
          day="20"
          month="NOV"
          year="2024"
    ...
    template: `
      <div style="${box}">
        ...
        <div style="display:flex;flex-direction:column;gap:16px">
          <GameResultCard
            :homeTeam="{ name: 'Maccabi Kiryat Gat', score: 89, logoInitial: 'M' }"
            :awayTeam="{ name: 'Ironi Nahariya', score: 77, logoInitial: 'I' }"
            day="20"
            month="NOV"
            year="2024"
            league="Liga Leumit (Winner League)"
          />
          <GameResultCard
            :homeTeam="{ name: 'Maccabi Tel Aviv', score: 95, logoInitial: 'M', logoColor: '#FFE000' }"
            :awayTeam="{ name: 'Hapoel Jerusalem', score: 88, logoInitial: 'H', logoColor: '#EF4444' }"
            day="20"
            month="NOV"
            year="2024"
