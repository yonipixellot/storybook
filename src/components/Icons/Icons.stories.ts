  ...
  render: () => ({
    template: `
      <div style="${box}">
        ...
        <p style="${label}">3 custom SVGs + Bookmark (lucide). Active state fills solid, inactive is outline-only.</p>
        <hr style="${hr}" />
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:12px">
          ...
          <div style="${cell}">
            <div style="${tabPair}">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#979797" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              ...
              <svg width="22" height="22" viewBox="0 0 24 24" fill="#161616" stroke="#161616" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M6 9H4.5a2.5 2.5 0 010-5C7 4 7 7 7 7"/>
                <path d="M18 9h1.5a2.5 2.5 0 000-5C17 4 17 7 17 7"/>
                <path d="M18 2H6v7a6 6 0 0012 0V2z"/>
                <line x1="12" y1="15" x2="12" y2="19"/>
          ...
          <!-- Saved: Lucide Bookmark (current path) -->
          <div style="${cell}">
            <div style="${tabPair}">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#979797" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                <path d="M17 3a2 2 0 0 1 2 2v15a1 1 0 0 1-1.496.868l-4.512-2.578a2 2 0 0 0-1.984 0l-4.512 2.578A1 1 0 0 1 5 20V5a2 2 0 0 1 2-2z"/>
              </svg>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="#161616" stroke="#161616" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                <path d="M17 3a2 2 0 0 1 2 2v15a1 1 0 0 1-1.496.868l-4.512-2.578a2 2 0 0 0-1.984 0l-4.512 2.578A1 1 0 0 1 5 20V5a2 2 0 0 1 2-2z"/>
              </svg>
            </div>
          ...
          <!-- Shop: rounded bag + handle loop + smile arc -->
          <div style="${cell}">
            <div style="${tabPair}">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#979797" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
              ...
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#161616" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                <rect x="3" y="8" width="18" height="13" rx="2" fill="#161616"/>
                <path d="M16 8V6a4 4 0 00-8 0v2"/>
                <path d="M9 14c1.5 1.5 4.5 1.5 6 0" stroke="white"/>
              </svg>
            </div>
  ...
  render: () => ({
    ...
    template: `
      <div style="border:1px solid #444;border-radius:16px;padding:28px 32px">
        <p style="font-size:18px;font-weight:700;margin:0 0 16px;font-family:Red Hat Display,sans-serif;color:#E8E8E8">Dark Mode — Lucide Icons</p>
        <div style="display:grid;grid-template-columns:repeat(6,1fr);gap:12px">
          ${lucideNames.map(name => `
          <div style="display:flex;flex-direction:column;align-items:center;gap:6px">
            <div style="width:40px;height:40px;border-radius:8px;background:#333;display:flex;align-items:center;justify-content:center;color:#E8E8E8"><${name} :size="20" /></div>
            <span style="font-size:10px;color:#888;text-align:center">${name}</span>
          </div>`).join('')}
        </div>
      </div>
    `,
