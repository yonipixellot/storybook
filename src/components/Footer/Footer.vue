<template>
  <footer class="ft" role="contentinfo">
    ...
    <div class="ft__nav">
      <div class="ft__logo">
        <img v-if="logoUrl" :src="logoUrl" :alt="orgName" class="ft__logo-img" />
        <div v-else class="ft__logo-placeholder">
          <svg aria-hidden="true" width="16" height="16" viewBox="0 0 18 18" fill="none">
            <rect x="1" y="1" width="16" height="16" rx="3" fill="white" opacity="0.9" />
            <rect x="4" y="4" width="10" height="10" rx="2" fill="var(--color-primary)" />
          </svg>
        </div>
      </div>
