...
export const DarkMode: Story = {
  name: 'Dark Mode',
  decorators: [() => ({ template: '<div data-theme="dark" style="background:#1A1A1A;padding:24px;border-radius:12px"><story /></div>' })],
  render: () => ({
    components: { PBellIcon },
    template: `
      <div style="border:1px solid #444;border-radius:16px;padding:28px 32px">
        ...
        <div style="display:flex;gap:32px;align-items:center">
          <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
            <PBellIcon :count="0" />
            <span style="font-family:Red Hat Display,sans-serif;font-size:11px;color:#888">No badge</span>
          </div>
          <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
            <PBellIcon :count="3" />
            <span style="font-family:Red Hat Display,sans-serif;font-size:11px;color:#888">count = 3</span>
          </div>
          <div style="display:flex;flex-direction:column;align-items:center;gap:8px">
            <PBellIcon :count="99" />
            <span style="font-family:Red Hat Display,sans-serif;font-size:11px;color:#888">count = 99</span>
          </div>
        </div>
      </div>
    `,
